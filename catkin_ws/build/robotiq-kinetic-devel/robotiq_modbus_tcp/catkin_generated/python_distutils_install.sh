...
echo_and_run cd "/home/kcg/catkin_ws/src/robotiq-kinetic-devel/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/kcg/catkin_ws/src/robotiq-kinetic-devel/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/kcg/catkin_ws/build/robotiq-kinetic-devel/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
