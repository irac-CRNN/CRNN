...
class SetPayloadRequest(genpy.Message):
  _md5sum = "64b3422bbd99d5e93a0503b0d28772e4"
...
float64 y
float64 z"""
  __slots__ = ['mass','payload','center_of_gravity']
  _slot_types = ['float32','float32','geometry_msgs/Vector3']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       mass,payload,center_of_gravity
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2f3d().pack(_x.mass, _x.payload, _x.center_of_gravity.x, _x.center_of_gravity.y, _x.center_of_gravity.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mass, _x.payload, _x.center_of_gravity.x, _x.center_of_gravity.y, _x.center_of_gravity.z,) = _get_struct_2f3d().unpack(str[start:end])
      return self
...
class SetPayload(object):
  ...
  _md5sum = 'fd8395846ef98349365c0999ffa4cb6a'
