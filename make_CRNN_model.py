...
base_model = ResNet50(include_top=False, weights='imagenet', input_shape=(108,192,3), pooling='max')

model = Sequential()
model.add(TimeDistributed(base_model, input_shape=(None,108,192,3)))
"""
model.add(TimeDistributed(Conv2D(32, (3,3), activation='relu', padding='same'), input_shape=(26,192,108,3)))
